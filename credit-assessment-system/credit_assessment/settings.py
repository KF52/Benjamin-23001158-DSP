...
ROOT_URLCONF = 'credit_assessment.urls'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for loan lending and loan eligbility assessment',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'COMPONENT_SPLIT_REQUEST': True,
    'TAGS': [
        {'name': 'auth', 'description': 'Authentication and user management'},
        {'name': 'prediction', 'description': 'Credit score predictions'}, 
